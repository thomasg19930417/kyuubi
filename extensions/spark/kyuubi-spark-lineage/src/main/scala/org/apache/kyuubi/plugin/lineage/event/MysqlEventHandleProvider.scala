...
class MysqlEventHandleProvider extends CustomEventHandlerProvider {
   ...
   */
  override def create(kyuubiConf: KyuubiConf): EventHandler[KyuubiEvent] = new MysqlEventHandle
}
